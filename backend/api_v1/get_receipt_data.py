...
|{transaction.store_code.store_code}:{transaction.store_code.name}

|{transaction.date.strftime('%Y年%m月%d日 %H:%M')}
|担当:{staff_code}{staff_name}
|取引ID:{terminal_id}-{sale_id}
{{border:none}}
...
"""
    ...
    for product in sale_products:
        ...
        receipt += f"{jan_last_3_digits} |{product.name} | ×{product.quantity} | ¥{product.price:,}{is_reduced_tax}\n"
